...
public final class TestSocialNetworkUser {
    ...
    public static void main(final String... args) {
         ...
         */
        final SocialNetworkUser<User> kbacon = new SocialNetworkUserImpl<User>("Kevin", "Bacon", 
        		"kbacon", 56);
        final SocialNetworkUser<User> dwashington = new SocialNetworkUserImpl<User>("Denzel",
        		"Washington", "dwashington", 59);
        final SocialNetworkUser<User> mgladwell = new SocialNetworkUserImpl<User>("Malcom", 
        		"Gladwell", "mgladwell", 51);
        final SocialNetworkUser<User> ntaleb = new SocialNetworkUserImpl<User>("Nicholas", 
        		"Taleb", "ntaleb", 54);
